...
//Задание 1
//        Date dateBegin = new Date(2022, 11, 20, 12, 40);
//        Date dateEnd = new Date();
//        System.out.print("Курбанов Ислам:\n    Дата получения работы: " + dateBegin.toString()
//                + "\n    Дата завершения работы: " + dateEnd.toString());
//Задание 2
//        Scanner scan = new Scanner(System.in);
//        System.out.print("Введите дату (в таком формате 2021-11-11): ");
...
//        System.out.print("Введите дату (в таком формате YYYY-MM-DD): ");
//        String stringDate = scan.next();
//        Date personDate = new SimpleDateFormat("y-M-d").parse(stringDate);
